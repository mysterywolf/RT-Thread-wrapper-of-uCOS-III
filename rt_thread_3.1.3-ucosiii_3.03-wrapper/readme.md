...
​	本兼容层完全兼容官方给出的标准初始化流程，如果您兼容老项目，初始化部分无需做任何修改。具体初始化流程代码参见工程`main.c`文件，参考文献参见[docs/HOW THE EXAMPLE PROJECT WORKS.pdf](docs/HOW THE EXAMPLE PROJECT WORKS.pdf)
