...
#define  OS_CFG_APP_HOOKS_EN             1u                 /* 只读 Enable (1) or Disable (0) application specific hooks                  */
#else
...
#define  OS_CFG_TLS_TBL_SIZE             0u                 /* 只读,该功能尚未实现 Include code for Task Local Storage (TLS) registers*/
                                                            ...
                                                            /* ------------------------- TIMER MANAGEMENT -------------------------- */
#define  OS_CFG_TMR_EN             RT_USING_TIMER_SOFT      /* 只读 Enable (1) or Disable (0) code generation for TIMERS */
